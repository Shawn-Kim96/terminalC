...
from terminalc.utils.timing_utils import timeit, timer
from terminalc.data_scripts.core.technical_analysis.divergence import DivergenceDetector
from terminalc.data_scripts.core.technical_indicators import add_technical_indicators, preprocess_peaks_strict
from terminalc.data_scripts.core.indicator_signals import (
    generate_indicator_signals,
    summarize_indicator_signals,
)
from terminalc.data_scripts.strategy import build_strategy_catalog
from terminalc.data_scripts.core.data_fetcher import (
    DataFetcher,
    _find_latest_dataset_dir,
    _infer_start_time_from_data,
)
import terminalc.data_scripts.database.injest_to_duckdb as injest_db
...
def run_coindesk_scraper():
    ...
    import terminalc.data_scripts.web.coindesk_scraper as coindesk_scraper
